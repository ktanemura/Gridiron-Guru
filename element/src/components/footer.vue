  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="#" class="footer-main-link" target="_blank">Link 1</a>
        <a :href="`${ var_url }`" class="footer-main-link" target="_blank">Link 2 with var URL</a>
      </div>
      <div class="footer-social">
        <el-popover
          ...
          trigger="hover">
          <div class="footer-popover-title">QR Code</div>
